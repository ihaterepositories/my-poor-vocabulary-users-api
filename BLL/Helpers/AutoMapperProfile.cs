...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        CreateMap<Teacher, GetTeacherAccountDto>()
            .ForMember(d => d.StudentsCredentials, o => o.MapFrom(t => t.Students))
            .ForMember(d => d.SchoolCredentials, o => o.MapFrom(t => t.School));
        ...
        CreateMap<School, GetSchoolAccountDto>()
            .ForMember(d => d.StudentsCredentials, o => o.MapFrom(s => s.Students))
            .ForMember(d => d.TeachersCredentials, o => o.MapFrom(s => s.Teachers));
            
        CreateMap<School, GetSchoolCredentialsDto>().ReverseMap();
        CreateMap<School, CreateSchoolDto>().ReverseMap();
        
        // STUDENT
        CreateMap<Student, GetStudentCredentialsDto>()
